insert into bundled_products(bundled_product_id,createdate,name, deleted, calls,sms,internet) values ('cdc153c2-d216-11ed-afa1-0242ac120002',current_timestamp,'sdfadf',true, 1, 1,1);
...
insert into tariffs(tariff_id,createdate,name, archived, deleted,bundled_product_id) values ('71b862e0-d217-11ed-afa1-0242ac120002',current_timestamp,'bbbbbb',false, true, 'f0429ab4-d216-11ed-afa1-0242ac120002');
